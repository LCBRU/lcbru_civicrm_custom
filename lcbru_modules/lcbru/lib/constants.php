...
// SPIRAL
define('CIVI_CASE_TYPE_SPIRAL', 'SPIRAL');
define('CIVI_FIELD_SET_SPIRAL', 'SPIRAL');
define('CIVI_FIELD_SPIRAL_ID', 'SPIRAL ID');
...
// DISCORDANCE
define('CIVI_CASETYPE_DISCORDANCE', 'DISCORDANCE');

define('CIVI_CUSTOMGROUP_DISCORDANCE', 'DISCORDANCE');
define('CIVI_FIELD_DISCORDANCE_ID', 'DISCORDANCE ID');
...
// PRE-ECLAMPSIA
define('CIVI_CASETYPE_PRE_ECLAMPSIA', 'PREECLAMPSIA');

define('CIVI_CUSTOMGROUP_PRE_ECLAMPSIA', 'PREECLAMPSIA');
define('CIVI_FIELD_PRE_ECLAMPSIA_ID', 'PREECLAMPSIA ID');

// CARDIOMET
define('CIVI_CASETYPE_CARDIOMET', 'CARDIOMET');
...
define('CIVI_ACTIVITY_BLOODS_DESTROYED', 'Bloods Destroyed');
