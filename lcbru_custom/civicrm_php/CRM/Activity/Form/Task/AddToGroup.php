 ...
 */
class CRM_Activity_Form_Task_AddToGroup extends CRM_Activity_Form_Task {
   ...
   */
  function addRules() {
    $this->addFormRule(array('CRM_Activity_Form_task_AddToGroup', 'formRule'));
  }
  ...
  public function postProcess() {
    ...
    foreach ($this->_activityHolderIds as $activityId) {
      $contactIds = array_merge($contactIds, CRM_Activity_BAO_ActivityTarget::retrieveTargetIdsByActivityId($activityId));
    }
    $contactIds = array_unique($contactIds);

    list($total, $added, $notAdded) = CRM_Contact_BAO_GroupContact::addContactsToGroup($contactIds, $groupID);
