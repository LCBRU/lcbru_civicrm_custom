...
";
  ...
  public static function sendSMS(
    ...
    // LCBRU Mod - Remove 1 - Remove the next 1
    // $text = &$activityParams['sms_text_message'];

    // LCBRU Mod - Add 1 - Added the next 2
    ...
    // LCBRU Mod - Add 2 - Added the next 3
    ...
    // LCBRU Mod - Add 3 - Added the next 7
    // CRM-6265: save both text and HTML parts in details (if present)
    if ($html and $text) {
      $details = "-ALTERNATIVE ITEM 0-\n$html\n-ALTERNATIVE ITEM 1-\n$text\n-ALTERNATIVE END-\n";
    }
    ...
    // LCBRU Mod - Remove 2 - Remove the next 1
    // $details = $text;
    ...
    foreach ($contactDetails as $values) {
      ...
      // LCBRU Mod - Add 4 - Added the next 2
      $tokenHtml = CRM_Utils_Token::replaceContactTokens($html, $values, TRUE, $messageToken, FALSE, $escapeSmarty);
      $tokenHtml = CRM_Utils_Token::replaceHookTokens($tokenHtml, $values, $categories, TRUE, $escapeSmarty);
      ...
      // LCBRU Mod - Add 5 - Added the $tokenHtml
  ...
  // LCBRU Mod - Add 6 - Added the $tokenHtml
  public static function sendSMSMessage(
    ...
    elseif ($toID) {
      ...
      if (!empty($toPhoneNumbers)) {
        ...
        // LCBRU Mod - Remove 4 - Remove the next 1
        // $toPhoneNumber = CRM_Utils_Array::value('phone', $toPhoneNumerDetails);
        // LCBRU Mod - Add 7 - Added the next 1
        $smsParams['To'] = $toPhoneNumber = CRM_Utils_Array::value('phone', $toPhoneNumerDetails); //Putting phone number back into smsParams
    ...
    // LCBRU Mod - Add 8 - Replace tokenText with message
