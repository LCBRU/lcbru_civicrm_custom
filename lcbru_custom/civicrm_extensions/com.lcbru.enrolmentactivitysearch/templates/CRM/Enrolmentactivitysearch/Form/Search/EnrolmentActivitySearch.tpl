{*
 ...
 +--------------------------------------------------------------------+
*}
{* Template for "EnrolmentActivitySearch" custom search component. *}
...
<div class="crm-content-block">
  ...
  <div class="crm-results-block crm-results-block-empty">
    {include file="CRM/Enrolmentactivitysearch/Form/Search/EmptyResults.tpl"}
    </div>
{/if}
...
{if $rows}
  ...
  <div class="crm-search-tasks">
    {include file="CRM/Enrolmentactivitysearch/Form/Search/ResultTasks.tpl"}
  </div>
    ...
    <table summary="{ts}Search results listings.{/ts}">
        ...
        {foreach from=$rows item=row}
            <tr id='rowid{counter}' class="{cycle values="odd-row,even-row"}">
                ...
                {foreach from=$columnHeaders item=header}
                    {if ($header.sort eq 'sort_name') or ($header.sort eq 'case_type') or ($header.sort eq 'case_status') or ($header.sort eq 'activity_status') or ($header.sort eq 'activity_type') or ($header.sort eq 'activity_subject') or ($header.sort eq 'source_contact') or ($header.sort eq 'activity_date') or ($header.sort eq 'location') or ($header.sort eq 'duration') or ($header.name eq null) }
